...
\section*{Aufgabe 1: Erstes Mal Taylor-Entwicklung}
  ...
  \begin{enumerate}
    ...
    f''(x) &= \frac{2}{3} \left(\frac{-2}{3}\right) (2x + 2)^{-5/3} \cdot 2 &= -\frac{8}{9} (2x + 2)^{-5/3} \\ 
    \end{align*}
  ...
  \begin{enumerate}
    ...
    Ergänzung: Binomialkoeffizient und allgemeiner Binomialkoeffizient

    \begin{align*}
      {n \choose k} &=  \frac{n!}{k! \cdot (n-k)!} \quad \text{mit } n\in \mathbb{N}\\
      \binom \alpha k &=
\begin{cases}\frac{\alpha (\alpha - 1)(\alpha - 2) \dotsm (\alpha - (k - 1))}{k!}, &\text{wenn }\quad k>0\\
1, &\text{wenn } \quad k=0\\
0, &\text{wenn } \quad k<0
\end{cases} \quad \text{mit } \alpha\in \mathbb{R}\\
      \end{align*}
  ...
  Bestimmen Sie das Taylorpolynom der Funktion $f(x)$ bis zur dritten nicht-verschwindenden Ordnung
  \begin{enumerate}
